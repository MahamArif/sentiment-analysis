...
from tensorflow.keras.layers import Dense, Conv1D, Embedding, MaxPooling1D, GlobalAveragePooling1D
...
plt.savefig('/model/accuracy_cnn.png')
...
def ConfusionMatrix(y_pred, y_test):
    ...
    plt.savefig('/model/confusion_matrix_cnn.png')
...
word2vec_model.wv.save('/model/Word2Vec-twitter-100-CNN')
word2vec_model.wv.save_word2vec_format('/model/Word2Vec-twitter-100-trainable-CNN')

# Saving the tokenizer
with open('/model/Tokenizer-CNN.pickle', 'wb') as file:
    pickle.dump(tokenizer, file)

# Saving the TF-Model.
training_model.save('/model/Sentiment-CNN')
training_model.save_weights("/model/weights-cnn")
